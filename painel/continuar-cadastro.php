...
<body>
	<div class="box-login">
		...
		<form method="post" action="">
			...
			<input type="password" name="password" placeholder="Senha..." value="<?php echo isset($_POST['password']) ? htmlentities($_POST['password']) : $_SESSION['dados_aluno']['nome']; ?>">
			<input type="password" name="password" placeholder="Senha..." value="<?php echo isset($_POST['password']) ? htmlentities($_POST['password']) : $_SESSION['dados_aluno']['sobrenome']; ?>">
